...
import { ICONS, PRIORITYSTYLES, TASK_TYPE } from "../utils/data";
...
export const Trash = () => {
  ...
  const deleteAllClick = () => {
    setType("deleteAll");
    setMsg("Quieres eliminar todos los elementos en la papelera?");
    setOpenDialog(true);
  };

  const restoreAllClick = () => {
    setType("restoreAll");
    setMsg("Quieres restaurar todos los elementos en la papelera?");
    setOpenDialog(true);
  };
  ...
  const deleteClick = (id) => {
    setSelected(id);
    setType("delete");
    setMsg("Quieres eliminar este elemento?");
    setOpenDialog(true);
  };
  ...
  const restoreClick = (id) => {
    setSelected(id);
    setType("restore");
    setMsg("Quieres restaurar este elemento?");
    setOpenDialog(true);
  };
